...
public class InserirPergunta extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					InserirPergunta window = new InserirPergunta();
	...
	private void initialize() {
		...
		lblNewLabel_1.setIcon(new ImageIcon(InserirPergunta.class.getResource("/view/back2.jpeg")));
