...
public class Categoria extends JFrame {
	...
	public Categoria() {
		...
		lblFundo.setIcon(new ImageIcon(Categoria.class.getResource("/view/back3.jpg")));
	}
}
