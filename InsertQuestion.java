...
public class InsertQuestion {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					InsertQuestion window = new InsertQuestion();
	...
	private void initialize() {
		...
		lblNewLabel_1.setIcon(new ImageIcon(InsertQuestion.class.getResource("/view/back2.jpeg")));
		lblNewLabel_1.setBounds(0, 2, 786, 563);
